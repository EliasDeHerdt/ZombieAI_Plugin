...
public:
	...
	virtual SteeringOutput CalculateSteering(float deltaT, const AgentInfo& pAgent) = 0;
...
public:
	...
	//Seek Behaviour
	SteeringOutput CalculateSteering(float deltaT, const AgentInfo& pAgent) override;
};
